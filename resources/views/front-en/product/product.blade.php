...
<section class="sec-product bg0 p-t-100 p-b-50" id="product">
    ...
    <div class="container">
        ...
        <div class="tab01">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item p-b-10">
                    <a class="nav-link active" data-toggle="tab" href="#allProducts" role="tab">All Product</a>
                </li>
        ...
        <div class="flex-c-m flex-w w-full p-t-45">
            <a href="/en/product" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
                Load More
            </a>
        </div>
    </div>
