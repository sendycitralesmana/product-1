        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    {{-- Modal --}}
                    @include('product.media.modal.add')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                @else
                                    <a href="/product/media/download/{{ $mediaProduct->id }}" class="btn btn-sm btn-success">Download</a>
                                @endif    
                            </td>
                            ...
                            <td>
                                ...
                                {{-- Modal --}}
                                @include('product.media.modal.edit')
                                <a href="/media-product/{{ $mediaProduct->id }}/delete"
