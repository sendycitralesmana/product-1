                        ...
                        <div class="col-lg-11">
                            <div class="hero__caption">
                                <div class="hero-text1">
                                    <span data-animation="fadeInUp" data-delay=".3s"> Electronic & IT Solution </span>
                                </div>
                                <h1 data-animation="fadeInUp" data-delay=".5s">Matahari</h1>
                                <div class="stock-text" data-animation="fadeInUp" data-delay=".8s">
                                    <h2>LED</h2>
                                    <h2>LED</h2>
                                </div>
                                <div class="hero-text2 mt-110" data-animation="fadeInUp" data-delay=".9s">
                                    <span><a href="services.html">Tentang Kami</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
