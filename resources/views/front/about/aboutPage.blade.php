	...
	<section class="bg0 p-t-104 p-b-120">
		<div class="container">
			<div class="row p-b-148">
				<div class="col-md-7 col-lg-8 tk-info">
			...
			<div class="row">
				...
				<div class="col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							{{-- <img src="{{ asset('storage/image/content/'. $aboutVM->thumbnail) }}" class="img-fluid" style="height: 400px; width: 100%') }}" alt="IMG"> --}}
							<img src="{{ asset('images/gambar.jpg') }}" alt="IMG">
						</div>
					</div>
				</div>

				<div class=" col-md-7 col-lg-8 p-b-30 vm-info">
