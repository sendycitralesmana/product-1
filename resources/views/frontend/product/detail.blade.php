                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-last-tab" data-toggle="tab" href="#nav-last"
                                        role="tab" aria-controls="nav-contact" aria-selected="false">Videos</a>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src=" {{ asset('assets/front-end/img/gallery/project1.png') }} "
                                                    alt="">
                                            </div>
                            ...
                            <div class="project-caption">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{asset('storage/product/media/'.$imgProduct->url)}}" alt=""
                        ...
                        <div class="project-caption">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-project mb-30">
                                        <div class="project-cap">
                                            <a href="/product/variant/{{ $variantProduct->id }}"
                                                class="plus-btn"><i>info</i></a>
                                            <h4><a
                                                    href="/product/variant/{{ $variantProduct->id }}">{{ $variantProduct->name }}</a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
