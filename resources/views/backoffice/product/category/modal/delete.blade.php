    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete productCategory</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a href="/backoffice/productCategory/{{ $productCategory->id }}/delete" class="btn btn-success">Delete</a>
                </div>
            </form>
        </div>
    </div>
