        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    {{-- Modal --}}
                    @include('about.history.modal.add')
                    @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                {{-- Modal --}}
                                @include('about.history.modal.desc')
                            </td>
                            <td>
                                @if (auth()->user()->role_id == 2)
                                <!-- Button trigger modal -->
                                ...
                                {{-- Modal --}}
                                @include('about.history.modal.edit')
                                <a href="/about/history/{{ $history->id }}/delete" onclick="return confirm('Are you sure?')"
