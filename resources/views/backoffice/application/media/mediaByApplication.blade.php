                    ...
                    @else
                        @foreach ($images as $image)
                            ...
                            <div class="col-md-3 gallery">
                                <div class="card">
                                    <div class="">
                                        <a href="{{asset('storage/image/application/media/'.$image->url)}}" data-title="{{ $image->name }}" data-lightbox="mygallery">
                                            <img src="{{asset('storage/image/application/media/'.$image->url)}}" alt="" 
