    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Hapus galeri {{$gallery->name}}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a href="/backoffice/gallery/{{ $gallery->id }}/delete" class="btn btn-danger"><span class="fas fa-trash"></span> Hapus</a>
                </div>
            </form>
        </div>
    </div>
