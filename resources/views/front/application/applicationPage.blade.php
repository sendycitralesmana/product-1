...
<div class="bg0 m-t-23 p-t-104 p-b-140">
    <div class="container">
        ...
        <div class="row isotope-grid">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $application->product_category_id }}">
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('assets/frontend/images/product-01.jpg') }}" alt="IMG-PRODUCT" height="250px">
