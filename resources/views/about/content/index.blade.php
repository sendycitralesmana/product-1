        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    {{-- Modal --}}
                    @include('about.content.modal.add')
                    @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <!-- Button trigger modal -->
                                ...
                                {{-- Modal --}}
                                @include('about.content.modal.desc') </td>
                            <td>
                                @if (auth()->user()->role_id == 2)
                                <!-- Button trigger modal -->
                                ...
                                {{-- Modal --}}
                                @include('about.content.modal.edit')
                                <a href="/about/content/{{ $content->id }}/delete" onclick="return confirm('Are you sure?')"
