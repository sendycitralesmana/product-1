<div class="modal fade" id="fileAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md ">
        <div class="modal-content">
            <form role="form" method="POST" action="/backoffice/application/{{ $application->id }}/file/create" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <table class="table table-bordered" id="dynamicAddRemoveVariant">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="file" id="file" accept=".pdf" name="media[]" class="form-control" placeholder="Enter media" required>
                                @if($errors->has('media[]'))
...
<script type="text/javascript">
    ...
    $("#add-btnVariant").click(function () {
        ...
        $("#dynamicAddRemoveVariant").append(
            `<tr>
                <td>
                    <input type="file" accept=".pdf, " name="media[]" class="form-control" placeholder="Enter media" required>
                    @if($errors->has('media[]'))
                    <span class="help-block" style="color: red">{{ $errors->first('media[]') }}</span>
                    @endif
                </td>
