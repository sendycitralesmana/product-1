        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop ">
                    <ul class="main-menu">
                        <li class="" >
                            <a href="/" style="{{ request()->is('/') ? 'color: #f58742 !important' : '' }}">Beranda</a>
                        </li>

                        <li class="">
                            <a href="/#product" style="{{ request()->is('product', 'product/*') ? 'color: #f58742 !important' : '' }}">Produk</a>
                            <ul class="sub-menu">
                        ...
                        <li class="">
                            <a href="/#application" style="{{ request()->is('application', 'application/*') ? 'color: #f58742 !important' : '' }}">Proyek</a>
                        </li>

                        <li class="">
                            <a href="/#blog" style="{{ request()->is('blog', 'blog/*') ? 'color: #f58742 !important' : '' }}">Berita</a>
                        </li>

                        <li class="">
                            <a href="/about" style="{{ request()->is('about') ? 'color: #f58742 !important' : '' }}">Tentang kami</a>
                        </li>

                        <li class="">
                            <a href="/contact" style="{{ request()->is('contact') ? 'color: #f58742 !important' : '' }}">Kontak kami</a>
                        </li>
                    </ul>
                </div>	
